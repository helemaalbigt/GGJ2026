...
public class Grabbable : MonoBehaviour
{
	...
	[SerializeField] private float _moveableLinear;
	[SerializeField] private float _unmoveableLinear;

	[SerializeField] private float _moveableAngular;
	[SerializeField] private float _unmoveableAngular;
	...
	{
		rigidBody.linearDamping = moveable ? _moveableLinear : _unmoveableLinear;
		rigidBody.angularDamping = moveable ? _moveableAngular : _unmoveableAngular;
	}
}
